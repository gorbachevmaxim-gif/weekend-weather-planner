...
export const RIDE_ANNOUNCEMENT_PROMPT = `Давай сделаем из этого текста анонс для райда с друзьями. Стиль дружественный и спокойный, поменьше структуры и совсем без иконок, чтобы был как проза. 
