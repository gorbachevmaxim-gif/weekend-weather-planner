    ...
    return (
        <div className="p-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                {renderWeatherBlock("ОСАДКИ", activeStats.isDry ? "0" : Number(activeStats.precipSum.toFixed(1)).toString(), " (мм)", (activeStats.isRideable && activeStats.rainHours) ? activeStats.rainHours : `Вероятность ${activeStats.precipitationProbability}%`)}
