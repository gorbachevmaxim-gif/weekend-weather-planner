...
const RoutesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg style={{ position: 'relative', top: '-5px', transform: 'rotate(45deg)' }} width="24" height="24" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
