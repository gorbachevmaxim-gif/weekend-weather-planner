...
interface GeminiAnnounceIconProps {
  width?: number;
  height?: number;
  className?: string;
}

const GeminiAnnounceIcon: React.FC<GeminiAnnounceIconProps> = ({ width = 24, height = 25, className = "" }) => {
  return (
    <svg
      width={width}
      height={height}
...
export default GeminiAnnounceIcon;
